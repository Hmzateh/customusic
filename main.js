...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let currentSlide = 0;
    const totalSlides = 2; // 0 = first 4, 1 = last 1 (slide 5)
    ...
    function updateSlider() {
        ...
        const shift = currentSlide * (visible * (cardWidth + gap));
    ...
    window.addEventListener('resize', () => { currentSlide = 0; updateSlider(); });
    updateSlider();
